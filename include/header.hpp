/**
 * @file header.hpp
 * @brief Biblioteca do programa
 *
 * @author Edye Lautter Cunha de Oliveira e Marciel Manoel Leal
 *
 */
 ...
 * */
 ...
 /**
  * @brief Fila e seu construtor com o tipo genérico F
...
class Erro{
    std::string str[10]={"Constante numérica inválida: um dos operandos da expressão está fora da faixa permitida. (Coluna: ",
                            ...
                            "Erro: expressão vazia!!"};//!<Vetor de strings contendo todos os erros detectáveis pelo programa
    int erro;//!<O número do erro
    int col;//!<Coluna da ocorrência do erro em relação à expressão original
    public:
        /**
        * @brief Contrutor da classe Erro
        * @param i é o tipo de erro
        * @param col é o número da coluna
        */
        Erro(int i=1,int col=0);
        /**@brief Definição do operador << para a classe Erro
        */
        inline friend
...
class Simbolo{
	...
	public:
		 ...
		 * @param col inteiro que será o novo número do atributo coluna
		 */
		void setCol(int col);
		/**
...
class Expressao{
    ...
    */
    ...
    public:
        ...
        * @param exp std::string que será o valor do atributo exp (A expressão matemática que se deseja trabalhar)
        */
        ...
        */
         ...
         * @param pOut um ponteiro do tipo std::ostream para onde a impressão dos elementos da fila de erros serão direcionadas
         * @see exprValue
        */
